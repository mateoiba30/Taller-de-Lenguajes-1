...
int main()        //fin 1 ganar, fin 2 perder, fin 0 seguir jugando
{
    ...
    while(fin==0){//a repetir hasta perder o ganar  EN VEZ DE PREGUNTAR 1 VEZ AFUERA PODR�A HABER USADO UN DO WHILE Y PREGUNTAR SIEMPRE ADENTRO
        getchar();//al usar getchar simplemente sigo apretando el enter, podr�a usar un scanf par que sirva cualquier tecla
        tirar_dados(&x, &y);
        printf("dado 1: %d \t dado 2: %d \n", x,y);
